...
function FeeGeneration() {
  ...
  if (loading) {
    return (
      <div className="bg-[#FAFAFA] text-[#292929] p-6 rounded-lg">
        <h2 className="text-2xl font-bold mb-4">Market Overview</h2>
        <div className="space-y-3">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div
              key={i}
              className="animate-pulse flex justify-between items-center bg-gray-800 p-4 rounded-lg"
            >
  ...
  return (
    <Layout>
      <main className="p-6 space-y-8">
        ...
        <div className="bg-[#FAFAFA] text-[#292929] p-6 rounded-lg shadow-xl">
          ...
          <div className="mt-6 pt-4 border-t border-gray-700">
            <div className="text-center text-sm text-[#292929]">
